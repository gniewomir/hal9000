...
Even with [validation of relative links to other Markdown files](../../projects/hal9000/done/relative-links-to-other-md-files.md), every **rename or move** can leave many notes with outdated paths. Fixing them by hand is tedious and error-prone. A checker alone tells you what broke; it does not **rewrite** links to follow the new layout.
